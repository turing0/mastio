	...
	return (
		...
		>
			...
			<div className="flex flex-col flex-1">
				...
				<div className="text-sm text-slate-900 mb-4 break-words whitespace-pre-wrap" dangerouslySetInnerHTML={{ __html: data?.content ? data?.content : data?.reblog?.content }}>
					{/* {data?.content} */}
